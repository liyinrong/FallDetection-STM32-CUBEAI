...
#ifndef AI_TINYFALLNET_QAT_H
#define AI_TINYFALLNET_QAT_H
#pragma once
...
/******************************************************************************/
#define AI_TINYFALLNET_QAT_MODEL_NAME          "tinyfallnet_qat"
#define AI_TINYFALLNET_QAT_ORIGIN_MODEL_NAME   "tinyfallnet_qat"

/******************************************************************************/
#define AI_TINYFALLNET_QAT_ACTIVATIONS_ALIGNMENT   (4)
#define AI_TINYFALLNET_QAT_INPUTS_IN_ACTIVATIONS   (4)
#define AI_TINYFALLNET_QAT_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_TINYFALLNET_QAT_IN_NUM        (1)

AI_DEPRECATED
#define AI_TINYFALLNET_QAT_IN \
  ai_tinyfallnet_qat_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_TINYFALLNET_QAT_IN_SIZE { \
  AI_TINYFALLNET_QAT_IN_1_SIZE, \
}
#define AI_TINYFALLNET_QAT_IN_SIZE_BYTES { \
  AI_TINYFALLNET_QAT_IN_1_SIZE_BYTES, \
}
#define AI_TINYFALLNET_QAT_IN_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_TINYFALLNET_QAT_IN_1_HEIGHT      (50)
#define AI_TINYFALLNET_QAT_IN_1_CHANNEL     (9)
#define AI_TINYFALLNET_QAT_IN_1_SIZE        (50 * 9)
#define AI_TINYFALLNET_QAT_IN_1_SIZE_BYTES  (1800)

/******************************************************************************/
#define AI_TINYFALLNET_QAT_OUT_NUM       (1)

AI_DEPRECATED
#define AI_TINYFALLNET_QAT_OUT \
  ai_tinyfallnet_qat_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_TINYFALLNET_QAT_OUT_SIZE { \
  AI_TINYFALLNET_QAT_OUT_1_SIZE, \
}
#define AI_TINYFALLNET_QAT_OUT_SIZE_BYTES { \
  AI_TINYFALLNET_QAT_OUT_1_SIZE_BYTES, \
}
#define AI_TINYFALLNET_QAT_OUT_1_FORMAT      AI_BUFFER_FORMAT_S8
#define AI_TINYFALLNET_QAT_OUT_1_CHANNEL     (2)
#define AI_TINYFALLNET_QAT_OUT_1_SIZE        (2)
#define AI_TINYFALLNET_QAT_OUT_1_SIZE_BYTES  (2)

/******************************************************************************/
#define AI_TINYFALLNET_QAT_N_NODES (31)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup tinyfallnet_qat
 ...
 * @ref ai_tinyfallnet_qat_create. Both the activations memory buffer 
 ...
 * using @ref ai_tinyfallnet_qat_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_tinyfallnet_qat_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_tinyfallnet_qat_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_TINYFALLNET_QAT_*
 * defines into file @ref tinyfallnet_qat.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_tinyfallnet_qat_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_TINYFALLNET_QAT_H */
